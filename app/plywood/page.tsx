    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const response = await fetchApi<ApiResponse<Product[]>>(API_ENDPOINTS.productsByCategory("693c4ae6013df282aa0ede1c"));
                ...
                <div className="text-center mb-16 relative overflow-hidden">
                    ...
                    <div className="relative animate-fadeInDown">
                        ...
                        <p className="text-lg text-gray-600 font-medium animate-fadeInUp delay-200">
                            Premium quality plywood for all your construction needs
                        </p>
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-16">
                        <div className="max-w-md mx-auto">
                            ...
                            <p className="text-gray-600">We couldn't find any plywood products at the moment. Please check back later.</p>
                        </div>
                    </div>
                ) : (
                    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
